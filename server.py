"""
This module sets up a Flask server for emotion detection.
"""
...
def sent_emotion():
    """
    Retrieves text from the request arguments, processes it through 
    the emotion detector, and returns a formatted string with the scores.
    """
